...
Let us the first crossing of zero after $\alpha$ \emph{without} the constraint at $W_1=0$, i.e.  $\tp = \inf_t \{W_t = 0 : W_\alpha = w, t\geq \alpha\}$. The standard result is
\begin{equation}
...
The density of arrival at $W_1=0$ is given by $\rho\left(W_1=0|W_\alpha=w\right) = \phi(w;1-\alpha)$ and so by Bayes' theorem we have
\begin{eqnarray}
